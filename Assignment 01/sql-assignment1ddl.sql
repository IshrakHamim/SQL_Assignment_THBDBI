-- Safe cleanup before creating tables
...
DROP TABLE units_sold CASCADE CONSTRAINTS;
DROP TABLE prices CASCADE CONSTRAINTS;
DROP TABLE activity CASCADE CONSTRAINTS;
DROP TABLE users CASCADE CONSTRAINTS;
DROP TABLE tv_program CASCADE CONSTRAINTS;
DROP TABLE content CASCADE CONSTRAINTS;
DROP TABLE queries CASCADE CONSTRAINTS;
DROP TABLE npv CASCADE CONSTRAINTS;
DROP TABLE employee_uni CASCADE CONSTRAINTS;
DROP TABLE employees CASCADE CONSTRAINTS;
DROP TABLE rides CASCADE CONSTRAINTS;
DROP TABLE users_detail CASCADE CONSTRAINTS;
DROP TABLE orders_34 CASCADE CONSTRAINTS;
DROP TABLE products_34 CASCADE CONSTRAINTS;
DROP TABLE movie_rating CASCADE CONSTRAINTS;
DROP TABLE users_35 CASCADE CONSTRAINTS;
DROP TABLE movies CASCADE CONSTRAINTS;
DROP TABLE students CASCADE CONSTRAINTS;
DROP TABLE departments CASCADE CONSTRAINTS;
DROP TABLE calls CASCADE CONSTRAINTS;
DROP TABLE warehouse CASCADE CONSTRAINTS;
DROP TABLE products_41 CASCADE CONSTRAINTS;
DROP TABLE sales_42 CASCADE CONSTRAINTS;
DROP TABLE employee_44 CASCADE CONSTRAINTS;
DROP TABLE student_45 CASCADE CONSTRAINTS;
DROP TABLE department_45 CASCADE CONSTRAINTS;
DROP TABLE customer CASCADE CONSTRAINTS;
DROP TABLE product_46 CASCADE CONSTRAINTS;
DROP TABLE project CASCADE CONSTRAINTS;
DROP TABLE employee_47 CASCADE CONSTRAINTS;
DROP TABLE enrollments CASCADE CONSTRAINTS;
DROP TABLE matches CASCADE CONSTRAINTS;
DROP TABLE players CASCADE CONSTRAINTS;
DROP TABLE customers CASCADE CONSTRAINTS;
DROP TABLE orders_28 CASCADE CONSTRAINTS;
DROP TABLE products_28 CASCADE CONSTRAINTS;
...
INSERT INTO delivery VALUES(2, 5,  to_date('2019-08-02','YYYY-MM-DD'),  to_date('2019-08-02','YYYY-MM-DD'));
INSERT INTO delivery VALUES(3, 1,  to_date('2019-08-11','YYYY-MM-DD'),  to_date('2019-08-11','YYYY-MM-DD'));
INSERT INTO delivery VALUES(4, 3,  to_date('2019-08-24','YYYY-MM-DD'),  to_date('2019-08-26','YYYY-MM-DD'));
INSERT INTO delivery VALUES(5, 4,  to_date('2019-08-21','YYYY-MM-DD'),  to_date('2019-08-22','YYYY-MM-DD'));
...
INSERT INTO weather VALUES(2, 15,  to_date('2019-11-01','YYYY-MM-DD'));
INSERT INTO weather VALUES(2, 12,  to_date('2019-10-28','YYYY-MM-DD'));
INSERT INTO weather VALUES(2, 12,  to_date('2019-10-27','YYYY-MM-DD'));
INSERT INTO weather VALUES(3, -2,  to_date('2019-11-10','YYYY-MM-DD'));
INSERT INTO weather VALUES(3, 0,  to_date('2019-11-11','YYYY-MM-DD'));
INSERT INTO weather VALUES(3, 3,  to_date('2019-11-12','YYYY-MM-DD'));
INSERT INTO weather VALUES(5, 16,  to_date('2019-11-07','YYYY-MM-DD'));
INSERT INTO weather VALUES(5, 18,  to_date('2019-11-09','YYYY-MM-DD'));
INSERT INTO weather VALUES(5, 21,  to_date('2019-11-23','YYYY-MM-DD'));
INSERT INTO weather VALUES(7, 25 ,  to_date('2019-11-28','YYYY-MM-DD'));
INSERT INTO weather VALUES(7 , 22,  to_date('2019-12-01','YYYY-MM-DD'));
INSERT INTO weather VALUES(7, 20,  to_date('2019-12-02','YYYY-MM-DD'));
INSERT INTO weather VALUES(8, 25,  to_date('2019-11-05','YYYY-MM-DD'));
INSERT INTO weather VALUES(8, 27,  to_date('2019-11-15','YYYY-MM-DD'));
INSERT INTO weather VALUES(8, 31,  to_date('2019-11-25','YYYY-MM-DD'));
INSERT INTO weather VALUES(9, 7,  to_date('2019-10-23','YYYY-MM-DD'));
INSERT INTO weather VALUES(9, 3,  to_date('2019-12-23','YYYY-MM-DD'));
...
INSERT INTO prices VALUES(1, to_date('2019-02-17','YYYY-MM-DD'), to_date('2019-02-28','YYYY-MM-DD'), 5);
INSERT INTO prices VALUES(1, to_date('2019-03-01','YYYY-MM-DD'), to_date('2019-03-22','YYYY-MM-DD'), 20);
INSERT INTO prices VALUES(2, to_date('2019-02-01','YYYY-MM-DD'), to_date('2019-02-20','YYYY-MM-DD'), 15);
INSERT INTO prices VALUES(2, to_date('2019-02-21','YYYY-MM-DD'), to_date('2019-03-31','YYYY-MM-DD'), 30);

INSERT INTO units_sold VALUES(1, to_date('2019-02-25','YYYY-MM-DD'), 100);
INSERT INTO units_sold VALUES(1, to_date('2019-03-01','YYYY-MM-DD'), 15);
INSERT INTO units_sold VALUES(2, to_date('2019-02-10','YYYY-MM-DD'), 200);
INSERT INTO units_sold VALUES(2, to_date('2019-03-22','YYYY-MM-DD'), 30);
...
INSERT INTO orders VALUES(1,to_date( '2020-02-05','YYYY-MM-DD'),60);
INSERT INTO orders VALUES(1,to_date( '2020-02-10','YYYY-MM-DD'),70);
INSERT INTO orders VALUES(2,to_date( '2020-01-18','YYYY-MM-DD'),30);
INSERT INTO orders VALUES(2,to_date( '2020-02-11' ,'YYYY-MM-DD'),80);
INSERT INTO orders VALUES(3,to_date( '2020-02-17','YYYY-MM-DD'),2);
INSERT INTO orders VALUES(3,to_date( '2020-02-24','YYYY-MM-DD'),3);
INSERT INTO orders VALUES(4,to_date( '2020-03-01','YYYY-MM-DD'),20);
INSERT INTO orders VALUES(4,to_date( '2020-03-04','YYYY-MM-DD'),30);
INSERT INTO orders VALUES(4,to_date( '2020-03-04','YYYY-MM-DD'),60);
INSERT INTO orders VALUES(5,to_date( '2020-02-25','YYYY-MM-DD'),50);
INSERT INTO orders VALUES(5,to_date( '2020-02-27','YYYY-MM-DD'),50);
INSERT INTO orders VALUES(5,to_date( '2020-03-01','YYYY-MM-DD'),50);
...
INSERT INTO tv_program VALUES(to_date('2020-06-10 08:00','YYYY-MM-DD HH24:MI'),1, 'LC-Channel');
INSERT INTO tv_program VALUES(to_date('2020-05-11 12:00','YYYY-MM-DD HH24:MI'),2, 'LC-Channel');
INSERT INTO tv_program VALUES(to_date('2020-05-12 12:00','YYYY-MM-DD HH24:MI'),3, 'LC-Channel');
INSERT INTO tv_program VALUES(to_date('2020-05-13 14:00','YYYY-MM-DD HH24:MI'),4, 'Disney Ch');
INSERT INTO tv_program VALUES(to_date('2020-06-18 14:00','YYYY-MM-DD HH24:MI'),4, 'Disney Ch');
INSERT INTO tv_program VALUES(to_date('2020-07-15 16:00','YYYY-MM-DD HH24:MI'),5, 'Disney Ch');
...
INSERT INTO users_detail VALUES(1, 'Alice');
INSERT INTO users_detail VALUES(2, 'Bob');
INSERT INTO users_detail VALUES(3, 'Alex');
INSERT INTO users_detail VALUES(4, 'Donald');
INSERT INTO users_detail VALUES(7, 'Lee');
INSERT INTO users_detail VALUES(13, 'Jonathan'); 
INSERT INTO users_detail VALUES(19, 'Elvis');
...
CREATE TABLE products_34
(
  product_id INT,
  product_name VARCHAR(30),
  product_category VARCHAR(30),
  CONSTRAINT pk_products34 PRIMARY KEY(product_id)
);

CREATE TABLE orders_34
(
  product_id INT,
  order_date DATE,
  unit INT,
  CONSTRAINT fk_product34 FOREIGN KEY (product_id)
    REFERENCES products(product_id) 
);

INSERT INTO products_34 VALUES(1, 'Leetcode Solutions', 'Book');
INSERT INTO products_34 VALUES(2, 'Jewels of Stringology', 'Book');
INSERT INTO products_34 VALUES(3, 'HP', 'Laptop');
INSERT INTO products_34 VALUES(4, 'Lenovo', 'Laptop');
INSERT INTO products_34 VALUES(5, 'Leetcode Kit', 'T-shirt');

INSERT INTO orders_34 VALUES(1,  to_date('2020-02-05','YYYY-MM-DD'),60);
INSERT INTO orders_34 VALUES(1,  to_date('2020-02-10','YYYY-MM-DD'),70);
INSERT INTO orders_34 VALUES(2,  to_date('2020-01-18','YYYY-MM-DD'),30);
INSERT INTO orders_34 VALUES(2,  to_date('2020-02-11','YYYY-MM-DD') ,80);
INSERT INTO orders_34 VALUES(3,  to_date('2020-02-17','YYYY-MM-DD'),2);
INSERT INTO orders_34 VALUES(3,  to_date('2020-02-24','YYYY-MM-DD'),3);
INSERT INTO orders_34 VALUES(4,  to_date('2020-03-01','YYYY-MM-DD'),20);
INSERT INTO orders_34 VALUES(4,  to_date('2020-03-04','YYYY-MM-DD'),30);
INSERT INTO orders_34 VALUES(4,  to_date('2020-03-04','YYYY-MM-DD'),60);
INSERT INTO orders_34 VALUES(5,  to_date('2020-02-25','YYYY-MM-DD'),50);
INSERT INTO orders_34 VALUES(5,  to_date('2020-02-27','YYYY-MM-DD'),50);
INSERT INTO orders_34 VALUES(5,  to_date('2020-03-01','YYYY-MM-DD'),50);
...
(
  user_id INT,
  name VARCHAR(25),
  CONSTRAINT pk_users35 PRIMARY KEY(user_id)
);
...
INSERT INTO users_35 VALUES(1, 'Daniel');
INSERT INTO users_35 VALUES(2, 'Monica');
INSERT INTO users_35 VALUES(3, 'Maria');
INSERT INTO users_35 VALUES(4, 'James');

INSERT INTO movie_rating VALUES(1, 1, 3, to_date('2020-01-12','YYYY-MM-DD'));
INSERT INTO movie_rating VALUES(1, 2, 4, to_date('2020-02-11','YYYY-MM-DD'));
INSERT INTO movie_rating VALUES(1, 3, 2, to_date('2020-02-12','YYYY-MM-DD'));
INSERT INTO movie_rating VALUES(1, 4, 1, to_date('2020-01-01','YYYY-MM-DD'));
INSERT INTO movie_rating VALUES(2, 1, 5, to_date('2020-02-17','YYYY-MM-DD'));
INSERT INTO movie_rating VALUES(2, 2, 2, to_date('2020-02-01','YYYY-MM-DD'));
INSERT INTO movie_rating VALUES(2, 3, 2, to_date('2020-03-01','YYYY-MM-DD'));
INSERT INTO movie_rating VALUES(3, 1, 3, to_date('2020-02-22','YYYY-MM-DD'));
INSERT INTO movie_rating VALUES(3, 2, 4, to_date('2020-02-25','YYYY-MM-DD'));
...
(
  ...
  length INT,
  height INT,
  CONSTRAINT pk_products41 PRIMARY KEY(product_id)
);
...
INSERT INTO products_41 VALUES(1, 'LC-TV', 5, 50, 40);
INSERT INTO products_41 VALUES(2, 'LC-KeyChain', 5, 5, 5);
INSERT INTO products_41 VALUES(3, 'LC-Phone', 2, 10, 10);
INSERT INTO products_41 VALUES(4, 'LC-T-Shirt', 4, 10, 20);
...
(
  ...
  fruit VARCHAR(10),
  sold_num INT,
  CONSTRAINT pk_sales42 PRIMARY KEY(sale_date, fruit)
);

INSERT INTO sales_42 VALUES( to_date('2020-05-01','YYYY-MM-DD'),'apples', 10);
INSERT INTO sales_42 VALUES( to_date('2020-05-01','YYYY-MM-DD'),'oranges', 8);
INSERT INTO sales_42 VALUES( to_date('2020-05-02','YYYY-MM-DD'),'apples', 15);
INSERT INTO sales_42 VALUES( to_date('2020-05-02','YYYY-MM-DD'),'oranges', 15);
INSERT INTO sales_42 VALUES( to_date('2020-05-03','YYYY-MM-DD'),'apples', 20);
INSERT INTO sales_42 VALUES( to_date('2020-05-03','YYYY-MM-DD'),'oranges', 0);
INSERT INTO sales_42 VALUES( to_date('2020-05-04','YYYY-MM-DD'),'apples', 15);
INSERT INTO sales_42 VALUES( to_date('2020-05-04','YYYY-MM-DD'),'oranges', 16);
...
(
  ...
  manager_id INT,
  CONSTRAINT pk_employee44 PRIMARY KEY(id)
);

INSERT INTO employee_44 VALUES(101, 'John', 'A', null);
INSERT INTO employee_44 VALUES(102, 'Dan', 'A', 101);
INSERT INTO employee_44 VALUES(103, 'James', 'A', 101);
INSERT INTO employee_44 VALUES(104, 'Amy', 'A', 101);
INSERT INTO employee_44 VALUES(105, 'Anne', 'A', 101);
INSERT INTO employee_44 VALUES(106, 'Ron', 'B', 101);

CREATE TABLE department_45
(
  dept_id INT,
  dept_name VARCHAR(30),
  CONSTRAINT pk_department45 PRIMARY KEY(dept_id)
);
...
(
  ...
  gender VARCHAR(1),
  dept_id INT,
  CONSTRAINT pk_student45 PRIMARY KEY(student_id),
  CONSTRAINT fk_department45 FOREIGN KEY (dept_id)
    REFERENCES department_45(dept_id) 
);

INSERT INTO department_45 VALUES(1, 'Engineering');
INSERT INTO department_45 VALUES(2, 'Science');
INSERT INTO department_45 VALUES(3, 'Law');

INSERT INTO student_45 VALUES(1, 'Jack', 'M', 1);
INSERT INTO student_45 VALUES(2, 'Jane', 'F', 1);
INSERT INTO student_45 VALUES(3, 'Mark', 'M', 2);
...
(
  product_key INT,
  CONSTRAINT pk_product46 PRIMARY KEY(product_key)
);
...
INSERT INTO product_46 VALUES(5);
INSERT INTO product_46 VALUES(6);
...
(
  ...
  CONSTRAINT pk_employee47 PRIMARY KEY(employee_id)
);
...
(
  ...
  name VARCHAR(30),
  price VARCHAR(50),
  CONSTRAINT pk_products_28 PRIMARY KEY(product_id)
);

INSERT INTO products_28 VALUES(10, 'LC Phone', 300);
INSERT INTO products_28 VALUES(20, 'LC T-Shirt', 10);
INSERT INTO products_28 VALUES(30, 'LC Book', 45);
INSERT INTO products_28 VALUES(40, 'LC Keychain', 2);
...
(
  ...
  order_date DATE,
  quantity INT,
  CONSTRAINT pk_orders_28 PRIMARY KEY(order_id)
);
        
INSERT INTO orders_28 VALUES(1, 1, 10, to_date('2020-06-10','YYYY-MM-DD'), 1);
INSERT INTO orders_28 VALUES(2, 1, 20, to_date('2020-07-01','YYYY-MM-DD'), 1);
INSERT INTO orders_28 VALUES(3, 1, 30, to_date('2020-07-08','YYYY-MM-DD'), 2);
INSERT INTO orders_28 VALUES(4, 2, 10, to_date('2020-06-15','YYYY-MM-DD'), 2);
INSERT INTO orders_28 VALUES(5, 2, 40, to_date('2020-07-01','YYYY-MM-DD'), 10);
INSERT INTO orders_28 VALUES(6, 3, 20, to_date('2020-06-24','YYYY-MM-DD'), 2);
